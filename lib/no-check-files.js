...
function tryAddIgnoreToFileSync(filePath, options) {
    if (isTSFile(filePath)) {
        ...
        if (!file.match(tsNoCheckRegex)) {
            ...
            fs_1.writeFileSync(filePath, "// @ts-nocheck\n// ^ Above line was added by ignore-bad-ts\n" + file);
        }
    }
}
                ...
                case 1:
                    ...
                    if (!file_1.match(tsNoCheckRegex)) {
                        ...
                        writePromise = new Promise(function (resolve, reject) {
                            fs_1.writeFile(filePath, "// @ts-nocheck\n// ^ Above line was added by ignore-bad-ts\n" + file_1, function (err) {
                                if (err) {
                                    reject(err);
                                }
                                else {
...
function ignoreFilesSync(fileGlobs, options) {
    ...
    var filePaths = fast_glob_1.default.sync(fileGlobs, __assign(__assign({}, globOptions), options));
...
function ignoreFiles(fileGlobs, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    filePathsStream = fast_glob_1.default.stream(fileGlobs, __assign(__assign({}, globOptions), options));
                    writePromises = [];
                    _b.label = 1;
                case 1:
